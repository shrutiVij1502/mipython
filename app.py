...
root@testlamp:/home/azureuser# cat  /var/www/cgi-bin/tasks_api.py
#!/usr/bin/python3
...
# Database connection parameters - update as needed
DB_USER=os.getenv('DB_USER') or 'admin1'
DB_PSWD=os.getenv('DB_PSWD') or 'azure@123'
DB_NAME=os.getenv('DB_NAME') or 'task_logger'
DB_HOST=os.getenv('DB_HOST') or 'test-lamp-db.mysql.database.azure.com'
